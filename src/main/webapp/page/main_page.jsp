...
<body>
	...
	<div class="side_navbar">
		...
		<a id="feed_upload_menu" class="link_tag_display" href="#add">
			<div class="navbar_menu_pos">
				...
				<form id="modal_feed_upload_form" action="/maums/feedUpload" method="POST" enctype="multipart/form-data">
					...
					<div class="modal_feed_image_area">
						<div class="modal_feed_image_upload_area">
							...
							<button id="image_upload_btn" type="button" class="btn btn-primary">사진찾기</button>
						</div>
					...
					<div class="modal_feed_text_area">
						...
						<div class="modal_feed_hashtag_box_area">
							<textarea id="modal_feed_hashtag_box" name="feed_hashtag" placeholder="해시태그를 입력하세요"></textarea>
						</div>
	...
	<!-- 사용자 정의 스크립트 -->
	<script src="${pageContext.request.contextPath}/js/main_page/main_feed_upload.js"></script>
