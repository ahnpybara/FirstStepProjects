...
<body>
	...
	<div id="root_div">
		...
		<div class="join_border_outline">
			...
			<!-- 이름 입력란 -->
            <div class="input_userData_area form-floating mb-3">
                <input id="input_name" type="text" name="name" class="input_userData form-control" placeholder="password">
				<label id="text_floating_label" for="input_name">이름</label>
			</div>
			<!-- 닉네임 입력란 -->
            <div class="input_userData_area form-floating mb-3">
                <input id="input_nickname" type="text" name="nickname" class="input_userData form-control" placeholder="password">
				<label id="text_floating_label" for="input_nickname">닉네임</label>
			</div>
			<!-- 비밀번호 입력란 -->
            <div class="input_userData_area form-floating mb-3">
			...
			<!-- 가입 버튼 -->
        	<input class="log_join_btn" type="submit" value="가입">
	</form>
		<!-- 로그인 페이지로 이동 -->
		<div>계정이 있으신가요? <a href="login.jsp"><b>로그인</b></a></div>
		</div>
	</div>
